...
const neighborsMapping: { [key: string]: string } = {
    "andreafabiola1997@gmail.com": generateAlertMessage("Andrea Rodríguez, hija de Pedro"),
    ...
    "cindygiselle6@gmail.com": generateAlertMessage("Cindy Díaz, esposa de Franklin"),
